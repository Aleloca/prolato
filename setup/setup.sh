...
print_summary() {
    ...
    echo ""
    echo "  3. Disable registration after creating admin:"
    echo "     Set DISABLE_REGISTRATION = true in /etc/gitea/app.ini"
    echo "     Then: systemctl restart gitea"
    echo ""
    echo "  4. Generate Gitea admin API token:"
    ...
    echo ""
    echo "  5. Add deploy-bot SSH key to Gitea admin:"
    echo "     cat /home/deploy/.ssh/id_ed25519.pub"
    echo "     Settings -> SSH/GPG Keys -> Add Key"
    echo ""
    echo "  6. Share with team: deploy token + domain"
