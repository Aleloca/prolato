  ...
  return (
    <div className="min-h-screen bg-[#0a0a0b] text-stone-100">
      ...
      <header className="relative">
        <div className="relative mx-auto max-w-7xl px-6 pb-20 pt-24 sm:pt-32 lg:pb-28 lg:pt-40">
          {/* Desktop: two columns */}
          <div className="flex flex-col items-center gap-16 lg:flex-row lg:items-center lg:gap-12 xl:gap-20">
            ...
            >
              ...
              <h1 className="font-display text-5xl tracking-tight text-stone-100 sm:text-6xl xl:text-7xl">
                Deploy from your terminal.
              </h1>

              <p className="mt-6 max-w-xl text-lg leading-relaxed text-stone-400 lg:mx-0">
            ...
            <motion.div
              ...
              className="w-full flex-1 lg:max-w-xl xl:max-w-2xl"
            >
              <TerminalDemo />
            </motion.div>
          </div>
